...
async def test_maindb_insert_header(db, contracts):
    ...
    main_db.write_block(header, uncles, transactions, receipts, accounts, reward, internal_transactions)
    main_db.disconnect()
    ...
    receipts = db.execute('SELECT * FROM receipts').fetchall()
    ...
    assert dict(logs[1]) == {
        ...
        'log_index': 1,
        'removed': False,
        'event_args': {"from": "0xe9b0363d2b53c534cc3d4a45b7024f991114d2ae", "to": "0x19947e2ba251384fb01c3c4c046a4a3802a388aa", "value": 100000000},
        'event_type': 'Transfer',
