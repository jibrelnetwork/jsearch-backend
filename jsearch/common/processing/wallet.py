...
def get_event_type(tx_data, contracts_set):
    ...
    if tx_data['to'] in contracts_set:
...
def event_from_tx(address, tx_data, contracts_set):
    """
...
def events_from_transactions(transactions, contracts_set):
    return [event_from_tx(t['address'], t, contracts_set) for t in transactions]
