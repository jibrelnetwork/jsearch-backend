...
ALTER TABLE blocks ALTER COLUMN timestamp TYPE BIGINT;
ALTER TABLE uncles ALTER COLUMN timestamp TYPE BIGINT;
ALTER TABLE token_transfers ALTER COLUMN timestamp TYPE BIGINT;
ALTER TABLE transactions ALTER COLUMN timestamp TYPE BIGINT;
ALTER TABLE internal_transactions ALTER COLUMN timestamp TYPE BIGINT;
"""
...
ALTER TABLE logs ALTER COLUMN timestamp TYPE INTEGER;
ALTER TABLE uncles ALTER COLUMN timestamp TYPE INTEGER;
ALTER TABLE blocks ALTER COLUMN timestamp TYPE INTEGER;
ALTER TABLE token_transfers ALTER COLUMN timestamp TYPE INTEGER;
ALTER TABLE transactions ALTER COLUMN timestamp TYPE INTEGER;
ALTER TABLE internal_transactions ALTER COLUMN timestamp TYPE INTEGER;
"""
