...
@service_bus.listen_stream(ROUTE_HANDLE_TRANSACTIONS, service_name='jsearch_wallet_worker')
...
@service_bus.listen_stream(ROUTE_WALLET_HANDLE_ACCOUNT_UPDATE, service_name='jsearch_wallet_worker')
...
@service_bus.listen_stream(ROUTE_WALLET_HANDLE_TOKEN_TRANSFER, service_name='jsearch_wallet_worker')
...
@service_bus.listen_stream(ROUTE_WALLET_HANDLE_ASSETS_UPDATE, service_name='jsearch_wallet_worker')
