...
JSEARCH_CONTRACT_API_URL = os.getenv('JSEARCH_CONTRACT_API_URL', 'http://localhost:8100')
JSEARCH_COMPILER_URL = os.getenv('JSEARCH_COMPILER_URL', 'http://localhost:8101')
